...
class Match {
    pass kw("match")
    value: ValueExpression
    cases: Block(MatchCase | FallbackCase)
}
...
def _parse_function_49(_ctx, _text, _pos):
    ...
    while True:
        ...
        # Option 2:
        # Begin Ref
        (_status, _result, _pos) = (yield (3, _ctx._try_Globals, _pos))
        # End Ref
        if _status:
            break
        if (farthest_pos1 < _pos):
        ...
        # Option 4:
        # Begin Ref
        (_status, _result, _pos) = (yield (3, _ctx._try_Variable, _pos))
        # End Ref
        if _status:
            break
        if (farthest_pos1 < _pos):
...
def _parse_function_47(_ctx, _text, _pos):
    # Begin Call
    # Lines(Definition | Globals | Template | Variable)
...
def _try_start(_ctx, _text, _pos):
    # Rule 'start'
    # Begin Discard
    # _try__ignored >> (wrap(Lines(Definition | Globals | Template | Variable)) << ExpectNot(/./))
    while True:
        # Begin Ref
        ...
        if not (_status):
            break
        # Begin Discard
        # wrap(Lines(Definition | Globals | Template | Variable)) << ExpectNot(/./)
        while True:
            # Begin Call
            # wrap(Lines(Definition | Globals | Template | Variable))
...
start = ParsingRule('start', _parse_start, """
    start = _try__ignored >> (wrap(Lines(Definition | Globals | Template | Variable)) << ExpectNot(/./))
""")
def _raise_error49(_text, _pos):
    ...
    '    Definition | Globals | Template | Variable\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
def _parse_function_67(_ctx, _text, _pos):
    # Begin Str
    value1 = 'class'
    end1 = (_pos + 5)
...
def _try_Class(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('class')
        arg3 = _wrap_string_literal('class', _parse_function_67)
...
def _parse_function_80(_ctx, _text, _pos):
    # Begin Str
    value2 = 'function'
    end2 = (_pos + 8)
...
def _try_Function(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('function')
        arg4 = _wrap_string_literal('function', _parse_function_80)
...
def _parse_function_102(_ctx, _text, _pos):
    # Begin Str
    value4 = 'graph'
    end4 = (_pos + 5)
...
def _parse_function_109(_ctx, _text, _pos):
    # Begin Choice
    farthest_err3 = _raise_error109
...
def _try_Graph(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('graph')
        arg5 = _wrap_string_literal('graph', _parse_function_102)
        ...
        name = _result
        # Begin Call
        # Block(Config | Edges | Function | Node | State | Variable)
        func9 = _ParseFunction(_ctx._try_Block, (_parse_function_109,), ())
...
def _raise_error109(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
    ...
    details = (
    "Failed to parse the 'Graph' rule, at the expression:\n"
    '    Config | Edges | Function | Node | State | Variable\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
def _parse_function_121(_ctx, _text, _pos):
    # Begin Str
    value5 = 'node'
    end5 = (_pos + 4)
...
def _parse_function_128(_ctx, _text, _pos):
    # Begin Choice
    farthest_err4 = _raise_error128
...
def _try_Node(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('node')
        arg6 = _wrap_string_literal('node', _parse_function_121)
        ...
        name = _result
        # Begin Call
        # Block(Config | Function | Handler | State | Variable)
        func11 = _ParseFunction(_ctx._try_Block, (_parse_function_128,), ())
...
def _raise_error128(_text, _pos):
    ...
    details = (
    "Failed to parse the 'Node' rule, at the expression:\n"
    '    Config | Function | Handler | State | Variable\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)

class Globals(ParsedObject):
    """
    class Globals {
        pass kw('globals')
        name: Opt(Name)
    ...
    def __repr__(self):
        return f'Globals(name={self.name!r}, body={self.body!r})'

    @staticmethod
    def parse(text, pos=0, fullparse=True):
        return _run(_ctx, text, pos, _ctx._try_Globals, fullparse)


def _parse_function_139(_ctx, _text, _pos):
    # Begin Str
    value6 = 'globals'
    end6 = (_pos + 7)
...
def _try_Globals(_ctx, _text, _pos):
    # Begin Seq
    start_pos5 = _pos
    while True:
        # Begin Call
        # kw('globals')
        arg7 = _wrap_string_literal('globals', _parse_function_139)
        ...
        # Begin Call
        # Block(Parameter)
        func13 = _ParseFunction(_ctx._try_Block, (_try_Parameter,), ())
        (_status, _result, _pos) = (yield (3, func13, _pos))
        # End Call
        if not (_status):
            break
        body = _result
        _result = Globals(name, body)
...
def _raise_error139(_text, _pos):
    if (len(_text) <= _pos):
        ...
        title = f'Error on line {line}, column {col}:\n{excerpt}\n'
    details = (
    "Failed to parse the 'Globals' rule, at the expression:\n"
    "    'globals'\n\n"
    "Expected to match the string 'globals'"
    )
    raise ParseError((title + details), _pos, line, col)
...
def _parse_function_152(_ctx, _text, _pos):
    # Begin Str
    value7 = 'template'
    end7 = (_pos + 8)
...
def _try_Template(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('template')
        arg8 = _wrap_string_literal('template', _parse_function_152)
        func14 = _ParseFunction(_ctx._try_kw, (arg8,), ())
        ...
        # Begin Call
        # ParenthesesList(Parameter)
        func15 = _ParseFunction(_ctx._try_ParenthesesList, (_try_Parameter,), ())
        ...
        # Begin Call
        # Block(Statement)
        func16 = _ParseFunction(_ctx._try_Block, (_try_Statement,), ())
...
class Variable(ParsedObject):
    ...
    def __repr__(self):
        return f'Variable(names={self.names!r}, value={self.value!r})'

    @staticmethod
    def parse(text, pos=0, fullparse=True):
        return _run(_ctx, text, pos, _ctx._try_Variable, fullparse)


def _try_Variable(_ctx, _text, _pos):
    # Begin Seq
    start_pos7 = _pos
    while True:
        # Begin Call
        # OptParenthesesList(AnnotatedName)
        func17 = _ParseFunction(_ctx._try_OptParenthesesList, (_try_AnnotatedName,), ())
...
def _raise_error176(_text, _pos):
    if (len(_text) <= _pos):
        ...
        title = f'Error on line {line}, column {col}:\n{excerpt}\n'
    details = (
    "Failed to parse the 'Variable' rule, at the expression:\n"
    "    '='\n\n"
    "Expected to match the string '='"
    )
    raise ParseError((title + details), _pos, line, col)

class AnnotatedName(ParsedObject):
    """
    class AnnotatedName {
        name: Name
        type: Opt(':' >> TypeExpression)
    ...
    def __repr__(self):
        return f'AnnotatedName(name={self.name!r}, type={self.type!r})'

    @staticmethod
    def parse(text, pos=0, fullparse=True):
        return _run(_ctx, text, pos, _ctx._try_AnnotatedName, fullparse)


def _try_AnnotatedName(_ctx, _text, _pos):
    # Begin Seq
    start_pos8 = _pos
    while True:
        # Begin Ref
        ...
        # End Opt
        type = _result
        _result = AnnotatedName(name, type)
...
def _raise_error185(_text, _pos):
    if (len(_text) <= _pos):
        ...
        title = f'Error on line {line}, column {col}:\n{excerpt}\n'
    details = (
    "Failed to parse the 'AnnotatedName' rule, at the expression:\n"
    "    ':'\n\n"
    "Expected to match the string ':'"
    )
    raise ParseError((title + details), _pos, line, col)
...
def _parse_function_196(_ctx, _text, _pos):
    # Begin Str
    value11 = 'edges'
    end11 = (_pos + 5)
...
def _parse_function_200(_ctx, _text, _pos):
    # Begin Choice
    farthest_err5 = _raise_error200
    backtrack15 = farthest_pos5 = _pos
    while True:
        # Option 1:
        # Begin Ref
...
def _try_Edges(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('edges')
        arg10 = _wrap_string_literal('edges', _parse_function_196)
        func18 = _ParseFunction(_ctx._try_kw, (arg10,), ())
        ...
        func19 = _ParseFunction(_ctx._try_Block, (_parse_function_200,), ())
...
def _parse_function_208(_ctx, _text, _pos):
    # Begin Str
    value12 = 'if'
    end12 = (_pos + 2)
...
def _parse_function_214(_ctx, _text, _pos):
    # Begin Choice
    farthest_err6 = _raise_error214
    backtrack16 = farthest_pos6 = _pos
    while True:
        # Option 1:
        # Begin Ref
        (_status, _result, _pos) = (yield (3, _ctx._try_ConditionalEdges, _pos))
...
def _try_ConditionalEdges(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('if')
        arg11 = _wrap_string_literal('if', _parse_function_208)
        func20 = _ParseFunction(_ctx._try_kw, (arg11,), ())
        ...
        # Begin Call
        # Block(ConditionalEdges | Edge)
        func21 = _ParseFunction(_ctx._try_Block, (_parse_function_214,), ())
...
def _parse_function_224(_ctx, _text, _pos):
    # Begin Str
    value13 = '>>'
    end13 = (_pos + 2)
...
def _try_Edge(_ctx, _text, _pos):
    ...
    while True:
        ...
        while True:
            ...
            # Begin Call
            # wrap('>>')
            arg12 = _wrap_string_literal('>>', _parse_function_224)
            func22 = _ParseFunction(_ctx._try_wrap, (arg12,), ())
...
def _parse_function_230(_ctx, _text, _pos):
    # Begin Str
    value14 = 'config'
    end14 = (_pos + 6)
...
def _try_Config(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('config')
        arg13 = _wrap_string_literal('config', _parse_function_230)
        func23 = _ParseFunction(_ctx._try_kw, (arg13,), ())
        ...
        # Begin Call
        # Block(Parameter)
        func24 = _ParseFunction(_ctx._try_Block, (_try_Parameter,), ())
...
def _parse_function_243(_ctx, _text, _pos):
    # Begin Str
    value15 = 'on'
    end15 = (_pos + 2)
...
def _try_Handler(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('on')
        arg14 = _wrap_string_literal('on', _parse_function_243)
        ...
        # Begin Call
        # ParenthesesList(Parameter)
        func26 = _ParseFunction(_ctx._try_ParenthesesList, (_try_Parameter,), ())
        ...
        # Begin Call
        # Block(Statement)
        func27 = _ParseFunction(_ctx._try_Block, (_try_Statement,), ())
...
def _parse_function_259(_ctx, _text, _pos):
    # Begin Str
    value16 = 'state'
    end16 = (_pos + 5)
...
def _try_State(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('state')
        arg15 = _wrap_string_literal('state', _parse_function_259)
        func28 = _ParseFunction(_ctx._try_kw, (arg15,), ())
        ...
        # Begin Call
        # Block(Parameter)
        func29 = _ParseFunction(_ctx._try_Block, (_try_Parameter,), ())
...
def _try_Statement(_ctx, _text, _pos):
    # Rule 'Statement'
    # Begin Choice
    farthest_err7 = _raise_error268
    backtrack19 = farthest_pos7 = _pos
    while True:
        # Option 1:
        # Begin Ref
...
Statement = ParsingRule('Statement', _parse_Statement, """
    Statement = Operate | Variable | Assign | Emit | For | Return | ValueExpression
""")
def _raise_error268(_text, _pos):
    ...
    '    Operate | Variable | Assign | Emit | For | Return | ValueExpression\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
def _try_Assign(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # OptParenthesesList(Storage)
        func30 = _ParseFunction(_ctx._try_OptParenthesesList, (_try_Storage,), ())
...
def _raise_error286(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
class Storage(ParsedObject):
    ...
    def __repr__(self):
        return f'Storage(target={self.target!r}, type={self.type!r})'

    @staticmethod
    def parse(text, pos=0, fullparse=True):
        return _run(_ctx, text, pos, _ctx._try_Storage, fullparse)


def _try_Storage(_ctx, _text, _pos):
    # Begin Seq
    start_pos16 = _pos
    while True:
        # Begin Ref
        ...
        # End Opt
        type = _result
        _result = Storage(target, type)
        _result._metadata.position_info = (start_pos16, _pos)
        break
    # End Seq
    yield (_status, _result, _pos)

def _raise_error304(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
        ...
        title = f'Error on line {line}, column {col}:\n{excerpt}\n'
    details = (
    "Failed to parse the 'Storage' rule, at the expression:\n"
    "    ':'\n\n"
    "Expected to match the string ':'"
    )
    raise ParseError((title + details), _pos, line, col)
...
class Emit(ParsedObject):
    ...
    def __repr__(self):
        return f'Emit(event={self.event!r}, target={self.target!r})'
...
def _try_Emit(_ctx, _text, _pos):
    ...
    while True:
        ...
        # End Opt
        target = _result
        _result = Emit(event, target)
        _result._metadata.position_info = (start_pos17, _pos)
        break
    # End Seq
    yield (_status, _result, _pos)

def _raise_error310(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error316(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
class For(ParsedObject):
    ...
    """
    _fields = ('storage', 'source', 'guard', 'body')

    def __init__(self, storage, source, guard, body):
        ParsedObject.__init__(self)
        self.storage = storage
        self.source = source
        self.guard = guard
    ...
    def __repr__(self):
        return f'For(storage={self.storage!r}, source={self.source!r}, guard={self.guard!r}, body={self.body!r})'
...
def _parse_function_323(_ctx, _text, _pos):
    # Begin Str
    value31 = 'for'
    end31 = (_pos + 3)
    if (_text[slice(_pos, end31, None)] == value31):
        ...
        _result = _raise_error323
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_331(_ctx, _text, _pos):
    # Begin Str
    value32 = 'in'
    end32 = (_pos + 2)
...
def _parse_function_341(_ctx, _text, _pos):
    # Begin Str
    value33 = 'if'
    end33 = (_pos + 2)
...
def _try_For(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('for')
        arg16 = _wrap_string_literal('for', _parse_function_323)
        func31 = _ParseFunction(_ctx._try_kw, (arg16,), ())
        ...
        item13 = _result
        # Begin Call
        # OptParenthesesList(Name)
        func32 = _ParseFunction(_ctx._try_OptParenthesesList, (_try_Name,), ())
        ...
        # Begin Call
        # kw('in')
        arg17 = _wrap_string_literal('in', _parse_function_331)
        func33 = _ParseFunction(_ctx._try_kw, (arg17,), ())
        ...
        while True:
            ...
            while True:
                ...
                # Begin Call
                # kw('if')
                arg18 = _wrap_string_literal('if', _parse_function_341)
                func34 = _ParseFunction(_ctx._try_kw, (arg18,), ())
        ...
        # Begin Call
        # Block(Statement)
        func35 = _ParseFunction(_ctx._try_Block, (_try_Statement,), ())
        (_status, _result, _pos) = (yield (3, func35, _pos))
        # End Call
        if not (_status):
            break
        body = _result
        _result = For(storage, source, guard, body)
...
def _raise_error341(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error353(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
    ...
    "Failed to parse the 'Operate' rule, at the expression:\n"
    "    'click'\n\n"
    "Expected to match the string 'click'"
    )
    raise ParseError((title + details), _pos, line, col)
...
def _raise_error354(_text, _pos):
    ...
    "Failed to parse the 'Operate' rule, at the expression:\n"
    "    'move'\n\n"
    "Expected to match the string 'move'"
    )
    raise ParseError((title + details), _pos, line, col)
...
def _parse_function_367(_ctx, _text, _pos):
    # Begin Str
    value39 = 'return'
    end39 = (_pos + 6)
...
def _try_Return(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('return')
        arg19 = _wrap_string_literal('return', _parse_function_367)
        func36 = _ParseFunction(_ctx._try_kw, (arg19,), ())
...
TypeExpression = ParsingRule('TypeExpression', _parse_TypeExpression, """
    TypeExpression = ValueExpression
""")
def _parse_function_382(_ctx, _text, _pos):
    # Begin Str
    value41 = 'not'
    end41 = (_pos + 3)
...
def _parse_function_422(_ctx, _text, _pos):
    ...
    if (_text[slice(_pos, end49, None)] == value49):
        ...
        _result = _raise_error422
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_425(_ctx, _text, _pos):
    # Begin Str
    value50 = '>>'
    end50 = (_pos + 2)
    if (_text[slice(_pos, end50, None)] == value50):
        ...
        _result = _raise_error425
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_433(_ctx, _text, _pos):
    # Begin Choice
    farthest_err17 = _raise_error433
    farthest_pos17 = _pos
    while True:
        # Option 1:
        # Begin Str
...
def _parse_function_456(_ctx, _text, _pos):
    # Begin Str
    value60 = '|'
    end60 = (_pos + 1)
    if (_text[slice(_pos, end60, None)] == value60):
        ...
        _result = _raise_error456
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_463(_ctx, _text, _pos):
    # Begin Str
    value61 = 'and'
    end61 = (_pos + 3)
...
def _parse_function_461(_ctx, _text, _pos):
    # Begin Call
    # kw('and')
    arg36 = _wrap_string_literal('and', _parse_function_463)
    func43 = _ParseFunction(_ctx._try_kw, (arg36,), ())
    (_status, _result, _pos) = (yield (3, func43, _pos))
    # End Call
    yield (_status, _result, _pos)

def _parse_function_470(_ctx, _text, _pos):
    # Begin Str
    value62 = 'or'
    end62 = (_pos + 2)
...
def _parse_function_468(_ctx, _text, _pos):
    # Begin Call
    # kw('or')
    arg38 = _wrap_string_literal('or', _parse_function_470)
    func45 = _ParseFunction(_ctx._try_kw, (arg38,), ())
...
def _try_ValueExpression(_ctx, _text, _pos):
    ...
    # Begin OperatorTable
    # Reference | LiteralExpression | AnonymousDefinition with operators {
    #     mixfix: ('(' >> wrap(ValueExpression)) << ')'
    #     postfix: ArgumentList, ElementAccess, FieldAccess, GenericArgumentList
    #     prefix: '-'
    #     left: '*', '/', '%'
    ...
    while True:
        while True:
            ...
            # Begin Longest
            has_result1 = False
            farthest_error_result1 = _raise_error375
            farthest_error_position1 = _raise_error375
            backtrack26 = farthest_position1 = farthest_error_position1 = _pos
            # Option 1:
            # Begin Apply
            # '-' |> `lambda x: (2, 0, x)`
            # Begin Str
            ...
            # Begin Call
            # kw('not')
            arg21 = _wrap_string_literal('not', _parse_function_382)
            func37 = _ParseFunction(_ctx._try_kw, (arg21,), ())
        ...
        # Begin Longest
        has_result2 = False
        farthest_error_result2 = _raise_error384
        farthest_error_position2 = _raise_error384
        backtrack27 = farthest_position2 = farthest_error_position2 = _pos
        # Option 1:
        # Begin Choice
        farthest_err10 = _raise_error385
        backtrack28 = farthest_pos10 = _pos
        while True:
            # Option 1:
            # Begin Ref
            (_status, _result, _pos) = (yield (3, _ctx._try_Reference, _pos))
            # End Ref
            if _status:
                break
        ...
        while True:
            ...
            while True:
                ...
                # Begin Call
                # wrap(ValueExpression)
                func38 = _ParseFunction(_ctx._try_wrap, (_try_ValueExpression,), ())
        ...
        # Option 3:
        # Begin Choice
        farthest_err11 = _raise_error396
        backtrack29 = farthest_pos11 = _pos
        while True:
            # Option 1:
            # Begin Ref
        ...
        while True:
            ...
            # Begin Choice
            farthest_err12 = _raise_error400
            backtrack30 = farthest_pos12 = _pos
            while True:
                # Option 1:
                # Begin Ref
        ...
        # Begin Longest
        has_result3 = False
        farthest_error_result3 = _raise_error406
        farthest_error_position3 = _raise_error406
        backtrack31 = farthest_position3 = farthest_error_position3 = _pos
        # Option 1:
        # Begin Apply
        # ('*' | '/' | '%') |> `lambda x: (3, 1, x)`
        # Begin Choice
        farthest_err13 = _raise_error408
        farthest_pos13 = _pos
        while True:
            # Option 1:
            # Begin Str
        ...
        # ('+' | '-') |> `lambda x: (4, 1, x)`
        # Begin Choice
        farthest_err14 = _raise_error414
        farthest_pos14 = _pos
        while True:
            # Option 1:
            # Begin Str
        ...
        # Begin Choice
        farthest_err15 = _raise_error419
        backtrack32 = farthest_pos15 = _pos
        while True:
            # Option 1:
            # Begin Call
            # wrap('<<')
            arg26 = _wrap_string_literal('<<', _parse_function_422)
            func39 = _ParseFunction(_ctx._try_wrap, (arg26,), ())
            ...
            # Begin Call
            # wrap('>>')
            arg27 = _wrap_string_literal('>>', _parse_function_425)
            func40 = _ParseFunction(_ctx._try_wrap, (arg27,), ())
        ...
        # Begin Choice
        farthest_err16 = _raise_error428
        backtrack33 = farthest_pos16 = _pos
        while True:
            # Option 1:
            # Begin Str
            value51 = '<='
            ...
            # Begin Call
            # RequiredSpace('<' | '>')
            func41 = _ParseFunction(_ctx._try_RequiredSpace, (_parse_function_433,), ())
        ...
        # Begin Choice
        farthest_err18 = _raise_error438
        backtrack34 = farthest_pos18 = _pos
        while True:
            # Option 1:
            # Begin Str
            value55 = 'in'
        ...
        # ('==' | '!=') |> `lambda x: (8, 3, x)`
        # Begin Choice
        farthest_err19 = _raise_error443
        farthest_pos19 = _pos
        while True:
            # Option 1:
            # Begin Str
        ...
        # Begin Call
        # wrap('|')
        arg34 = _wrap_string_literal('|', _parse_function_456)
        func42 = _ParseFunction(_ctx._try_wrap, (arg34,), ())
        ...
        # Begin Call
        # wrap(kw('and'))
        func44 = _ParseFunction(_ctx._try_wrap, (_parse_function_461,), ())
        ...
        # Begin Call
        # wrap(kw('or'))
        func46 = _ParseFunction(_ctx._try_wrap, (_parse_function_468,), ())
...
ValueExpression = ParsingRule('ValueExpression', _parse_ValueExpression, """
    ValueExpression = Reference | LiteralExpression | AnonymousDefinition with operators {
        mixfix: ('(' >> wrap(ValueExpression)) << ')'
        postfix: ArgumentList, ElementAccess, FieldAccess, GenericArgumentList
        prefix: '-'
        left: '*', '/', '%'
...
""")
def _raise_error374(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error384(_text, _pos):
    ...
    details = (
    "Failed to parse the 'ValueExpression' rule, at the expression:\n"
    "    Longest(Reference | LiteralExpression | AnonymousDefinition, ('(' >> wrap(ValueExpression)) << ')', If | Match)\n\n"
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
def _raise_error385(_text, _pos):
    ...
    details = (
    "Failed to parse the 'ValueExpression' rule, at the expression:\n"
    '    Reference | LiteralExpression | AnonymousDefinition\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
def _raise_error395(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error396(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error415(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error419(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error422(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error429(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error430(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error433(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error434(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error435(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error438(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error443(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error451(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error456(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
class Reference(ParsedObject):
    ...
    @staticmethod
    def parse(text, pos=0, fullparse=True):
        return _run(_ctx, text, pos, _ctx._try_Reference, fullparse)


def _try_Reference(_ctx, _text, _pos):
    # Begin Seq
    start_pos21 = _pos
    while True:
        # Begin Ref
...
def _try_LiteralExpression(_ctx, _text, _pos):
    ...
    # Begin Choice
    farthest_err20 = _raise_error481
    backtrack35 = farthest_pos20 = _pos
    while True:
        # Option 1:
        # Begin Ref
...
def _parse_function_497(_ctx, _text, _pos):
    # Begin Str
    value64 = ':'
    end64 = (_pos + 1)
    ...
    while True:
        ...
        while True:
            ...
            while True:
                ...
                # Begin Call
                # wrap(':')
                arg40 = _wrap_string_literal(':', _parse_function_497)
                func47 = _ParseFunction(_ctx._try_wrap, (arg40,), ())
...
def _raise_error494(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error497(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _try_ListLiteral(_ctx, _text, _pos):
    ...
    while True:
        ...
        func48 = _ParseFunction(_ctx._try_SquareList, (_try_ValueExpression,), ())
...
def _try_MapLiteral(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # CurlyList(Pair)
        func49 = _ParseFunction(_ctx._try_CurlyList, (_try_Pair,), ())
...
def _try_SetLiteral(_ctx, _text, _pos):
    ...
    while True:
        ...
        func50 = _ParseFunction(_ctx._try_CurlyList, (_try_ValueExpression,), ())
...
def _raise_error533(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _parse_function_542(_ctx, _text, _pos):
    # Begin Sep
...
def _try_TupleLiteral(_ctx, _text, _pos):
    ...
    while True:
        ...
        func51 = _ParseFunction(_ctx._try_wrap, (_parse_function_542,), ())
...
def _parse_function_554(_ctx, _text, _pos):
    # Begin Choice
    farthest_err21 = _raise_error554
    backtrack36 = farthest_pos21 = _pos
    while True:
        # Option 1:
        # Begin Call
        # KeywordArgument(ValueExpression)
        func52 = _ParseFunction(_ctx._try_KeywordArgument, (_try_ValueExpression,), ())
...
def _try_ArgumentList(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # ParenthesesList(KeywordArgument(ValueExpression) | ValueExpression)
        func53 = _ParseFunction(_ctx._try_ParenthesesList, (_parse_function_554,), ())
...
def _raise_error554(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
    ...
    '    KeywordArgument(ValueExpression) | ValueExpression\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
def _parse_function_566(_ctx, _text, _pos):
    # Begin Str
    value69 = '<'
    end69 = (_pos + 1)
    if (_text[slice(_pos, end69, None)] == value69):
        ...
        _result = _raise_error566
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_572(_ctx, _text, _pos):
    # Begin Str
    value70 = '>'
    end70 = (_pos + 1)
    ...
    while True:
        ...
        while True:
            ...
            while True:
                # Begin Call
                # ForbiddenSpace('<')
                arg42 = _wrap_string_literal('<', _parse_function_566)
                func54 = _ParseFunction(_ctx._try_ForbiddenSpace, (arg42,), ())
            ...
            # Begin Call
            # ForbiddenSpace('>')
            arg43 = _wrap_string_literal('>', _parse_function_572)
            func55 = _ParseFunction(_ctx._try_ForbiddenSpace, (arg43,), ())
...
def _raise_error566(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error572(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _try_GenericArgument(_ctx, _text, _pos):
    ...
    # Begin Choice
    farthest_err22 = _raise_error574
    backtrack37 = farthest_pos22 = _pos
    while True:
        # Option 1:
        # Begin Call
        # KeywordArgument(TypeExpression)
        func56 = _ParseFunction(_ctx._try_KeywordArgument, (_try_TypeExpression,), ())
...
GenericArgument = ParsingRule('GenericArgument', _parse_GenericArgument, """
    GenericArgument = KeywordArgument(TypeExpression) | TypeExpression
""")
def _raise_error574(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
    ...
    '    KeywordArgument(TypeExpression) | TypeExpression\n\n'
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)
...
class KeywordArgument(ParsedObject):
    ...
    @staticmethod
    def parse(T):
        _closure = _ParseFunction(_ctx._try_KeywordArgument, (T,), {})
        return lambda _ctx, text, pos=0, fullparse=True: _run(_ctx, text, pos, _closure, fullparse)


def _try_KeywordArgument(_ctx, _text, _pos, T):
    # Begin Seq
    start_pos32 = _pos
    while True:
        # Begin Ref
...
def _try_ElementAccess(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # SquareList(ValueExpression)
        func57 = _ParseFunction(_ctx._try_SquareList, (_try_ValueExpression,), ())
...
def _parse_function_604(_ctx, _text, _pos):
    # Begin Str
    value73 = 'if'
    end73 = (_pos + 2)
    if (_text[slice(_pos, end73, None)] == value73):
        ...
        _result = _raise_error604
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_616(_ctx, _text, _pos):
    # Begin Str
    value74 = 'else'
    end74 = (_pos + 4)
...
def _try_If(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('if')
        arg44 = _wrap_string_literal('if', _parse_function_604)
        func58 = _ParseFunction(_ctx._try_kw, (arg44,), ())
        ...
        while True:
            # Begin Call
            # kw('else')
            arg45 = _wrap_string_literal('else', _parse_function_616)
            func60 = _ParseFunction(_ctx._try_kw, (arg45,), ())
            ...
            # Begin Call
            # Block(Statement)
            func61 = _ParseFunction(_ctx._try_Block, (_try_Statement,), ())
...
def _raise_error604(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error616(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _parse_function_631(_ctx, _text, _pos):
    # Begin Choice
    farthest_err23 = _raise_error631
    backtrack39 = farthest_pos23 = _pos
    while True:
        # Option 1:
        # Begin Ref
        (_status, _result, _pos) = (yield (3, _ctx._try_MatchCase, _pos))
        # End Ref
        if _status:
            break
        ...
        # Option 2:
        # Begin Ref
        (_status, _result, _pos) = (yield (3, _ctx._try_FallbackCase, _pos))
        # End Ref
        if _status:
            break
        if (farthest_pos23 < _pos):
...
def _try_Match(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('match')
        arg46 = _wrap_string_literal('match', _parse_function_625)
        func62 = _ParseFunction(_ctx._try_kw, (arg46,), ())
        ...
        value = _result
        # Begin Call
        # Block(MatchCase | FallbackCase)
        func63 = _ParseFunction(_ctx._try_Block, (_parse_function_631,), ())
...
def _raise_error631(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _parse_function_639(_ctx, _text, _pos):
    # Begin Str
    value76 = 'case'
    end76 = (_pos + 4)
    if (_text[slice(_pos, end76, None)] == value76):
        ...
        _result = _raise_error639
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_648(_ctx, _text, _pos):
    # Begin Str
    value77 = 'if'
    end77 = (_pos + 2)
...
def _try_MatchCase(_ctx, _text, _pos):
    ...
    while True:
        # Begin Call
        # kw('case')
        arg47 = _wrap_string_literal('case', _parse_function_639)
        func64 = _ParseFunction(_ctx._try_kw, (arg47,), ())
        (_status, _result, _pos) = (yield (3, func64, _pos))
        # End Call
        if not (_status):
            break
        item22 = _result
        ...
        while True:
            # Begin Call
            # kw('if')
            arg48 = _wrap_string_literal('if', _parse_function_648)
            func65 = _ParseFunction(_ctx._try_kw, (arg48,), ())
            (_status, _result, _pos) = (yield (3, func65, _pos))
            # End Call
            if not (_status):
                break
            # Begin Ref
        ...
        # Begin Call
        # Block(Statement)
        func66 = _ParseFunction(_ctx._try_Block, (_try_Statement,), ())
        (_status, _result, _pos) = (yield (3, func66, _pos))
        # End Call
        if not (_status):
            break
        body = _result
...
def _raise_error639(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error648(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
class FallbackCase(ParsedObject):
    """
    class FallbackCase {
        pass kw('else')
        guard: Opt(kw('if') >> ValueExpression)
    ...
    def __repr__(self):
        return f'FallbackCase(guard={self.guard!r}, body={self.body!r})'

    @staticmethod
    def parse(text, pos=0, fullparse=True):
        return _run(_ctx, text, pos, _ctx._try_FallbackCase, fullparse)


def _parse_function_659(_ctx, _text, _pos):
    # Begin Str
    value78 = 'else'
    end78 = (_pos + 4)
    if (_text[slice(_pos, end78, None)] == value78):
        ...
        _result = _raise_error659
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_665(_ctx, _text, _pos):
    # Begin Str
    value79 = 'if'
    end79 = (_pos + 2)
    if (_text[slice(_pos, end79, None)] == value79):
        ...
        _result = _raise_error665
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _try_FallbackCase(_ctx, _text, _pos):
    # Begin Seq
    start_pos38 = _pos
    while True:
        # Begin Call
        # kw('else')
        arg49 = _wrap_string_literal('else', _parse_function_659)
        func67 = _ParseFunction(_ctx._try_kw, (arg49,), ())
        (_status, _result, _pos) = (yield (3, func67, _pos))
        # End Call
        if not (_status):
            break
        item23 = _result
        ...
        while True:
            # Begin Call
            # kw('if')
            arg50 = _wrap_string_literal('if', _parse_function_665)
            func68 = _ParseFunction(_ctx._try_kw, (arg50,), ())
            (_status, _result, _pos) = (yield (3, func68, _pos))
            # End Call
            if not (_status):
                break
            # Begin Ref
        ...
        # Begin Call
        # Block(Statement)
        func69 = _ParseFunction(_ctx._try_Block, (_try_Statement,), ())
        (_status, _result, _pos) = (yield (3, func69, _pos))
        # End Call
        if not (_status):
            break
        body = _result
        _result = FallbackCase(guard, body)
        _result._metadata.position_info = (start_pos38, _pos)
        break
    # End Seq
    yield (_status, _result, _pos)

def _raise_error659(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
        ...
        title = f'Error on line {line}, column {col}:\n{excerpt}\n'
    details = (
    "Failed to parse the 'FallbackCase' rule, at the expression:\n"
    "    'else'\n\n"
    "Expected to match the string 'else'"
    )
    raise ParseError((title + details), _pos, line, col)

def _raise_error665(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _parse_function_688(_ctx, _text, _pos):
    # Begin Str
    value82 = ','
    end82 = (_pos + 1)
...
def _try_Comma(_ctx, _text, _pos):
    ...
    # Begin Call
    # wrap(',')
    arg51 = _wrap_string_literal(',', _parse_function_688)
    func70 = _ParseFunction(_ctx._try_wrap, (arg51,), ())
    (_status, _result, _pos) = (yield (3, func70, _pos))
    # End Call
    yield (_status, _result, _pos)
...
LineSep = ParsingRule('LineSep', _parse_LineSep, """
    LineSep = /[\\n\\r]+/+
""")
def _raise_error691(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _raise_error703(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _try_OptParenthesesList(_ctx, _text, _pos, T):
    # Rule 'OptParenthesesList'
    # Begin Choice
    farthest_err24 = _raise_error711
    backtrack45 = farthest_pos24 = _pos
    while True:
        # Option 1:
        # Begin Discard
        # ('(' >> T) << ')'
        while True:
            ...
            while True:
                ...
                value85 = '('
                end85 = (_pos + 1)
                if (_text[slice(_pos, end85, None)] == value85):
                    _result = value85
                    _pos = (yield (3, _ctx._try__ignored, end85))[2]
                    _status = True
                else:
                    _result = _raise_error714
                    _status = False
                # End Str
                if not (_status):
                    break
            ...
            value86 = ')'
            end86 = (_pos + 1)
            if (_text[slice(_pos, end86, None)] == value86):
                _result = value86
                _pos = (yield (3, _ctx._try__ignored, end86))[2]
                _status = True
            else:
        ...
        # Begin Call
        # ParenthesesList(T)
        func71 = _ParseFunction(_ctx._try_ParenthesesList, (T,), ())
        (_status, _result, _pos) = (yield (3, func71, _pos))
        # End Call
        if _status:
            break
        if (farthest_pos24 < _pos):
        ...
        # Option 3:
        # Begin Sep
        # Sep(T, Comma, allow_trailer=true, require_separator=True)
        staging17 = []
        checkpoint6 = _pos
        saw_separator2 = False
        while True:
            # Begin Ref
            (_status, _result, _pos) = (yield (3, T, _pos))
            # End Ref
            ...
            checkpoint6 = _pos
            saw_separator2 = True
        if not staging17 or saw_separator2:
            _result = staging17
            _pos = checkpoint6
            _status = True
        # End Sep
...
def _parse_OptParenthesesList(text, pos=0, fullparse=True):
    return _run(_ctx, text, pos, _try_OptParenthesesList, fullparse)

OptParenthesesList = ParsingRule('OptParenthesesList', _parse_OptParenthesesList, """
    OptParenthesesList(T) = ('(' >> T) << ')' | ParenthesesList(T) | Sep(T, Comma, allow_trailer=true, require_separator=True) | T
""")
def _raise_error711(_text, _pos):
    if (len(_text) <= _pos):
        ...
        title = f'Error on line {line}, column {col}:\n{excerpt}\n'
    details = (
    "Failed to parse the 'OptParenthesesList' rule, at the expression:\n"
    "    ('(' >> T) << ')' | ParenthesesList(T) | Sep(T, Comma, allow_trailer=true, require_separator=True) | T\n\n"
    'Unexpected input'
    )
    raise ParseError((title + details), _pos, line, col)

def _raise_error714(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
SurroundedList = ParsingRule('SurroundedList', _parse_SurroundedList, """
    SurroundedList(L, T, R) = (((L >> Pad) >> (T /? Comma)) << Pad) << R
""")
def _parse_function_742(_ctx, _text, _pos):
    # Begin Str
    value87 = '{'
    end87 = (_pos + 1)
    if (_text[slice(_pos, end87, None)] == value87):
        _result = value87
        _pos = (yield (3, _ctx._try__ignored, end87))[2]
        _status = True
    else:
        _result = _raise_error742
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_744(_ctx, _text, _pos):
    # Begin Str
    value88 = '}'
    end88 = (_pos + 1)
    if (_text[slice(_pos, end88, None)] == value88):
        _result = value88
        _pos = (yield (3, _ctx._try__ignored, end88))[2]
        _status = True
    else:
...
def _try_CurlyList(_ctx, _text, _pos, T):
    ...
    # Begin Call
    # SurroundedList('{', T, '}')
    arg52 = _wrap_string_literal('{', _parse_function_742)
    arg53 = _wrap_string_literal('}', _parse_function_744)
    func72 = _ParseFunction(_ctx._try_SurroundedList, (arg52, T, arg53), ())
    (_status, _result, _pos) = (yield (3, func72, _pos))
    # End Call
    yield (_status, _result, _pos)
...
CurlyList = ParsingRule('CurlyList', _parse_CurlyList, """
    CurlyList(T) = SurroundedList('{', T, '}')
""")
def _raise_error742(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
def _parse_function_748(_ctx, _text, _pos):
    # Begin Str
    value89 = '('
    end89 = (_pos + 1)
    if (_text[slice(_pos, end89, None)] == value89):
        _result = value89
        _pos = (yield (3, _ctx._try__ignored, end89))[2]
        _status = True
    else:
...
def _parse_function_750(_ctx, _text, _pos):
    # Begin Str
    value90 = ')'
    end90 = (_pos + 1)
    if (_text[slice(_pos, end90, None)] == value90):
        _result = value90
        _pos = (yield (3, _ctx._try__ignored, end90))[2]
        _status = True
    else:
...
def _try_ParenthesesList(_ctx, _text, _pos, T):
    ...
    # Begin Call
    # SurroundedList('(', T, ')')
    arg54 = _wrap_string_literal('(', _parse_function_748)
    arg55 = _wrap_string_literal(')', _parse_function_750)
    func73 = _ParseFunction(_ctx._try_SurroundedList, (arg54, T, arg55), ())
    (_status, _result, _pos) = (yield (3, func73, _pos))
    # End Call
    yield (_status, _result, _pos)
...
def _parse_function_754(_ctx, _text, _pos):
    # Begin Str
    value91 = '['
    end91 = (_pos + 1)
    if (_text[slice(_pos, end91, None)] == value91):
        _result = value91
        _pos = (yield (3, _ctx._try__ignored, end91))[2]
        _status = True
    else:
        _result = _raise_error754
        _status = False
    # End Str
    yield (_status, _result, _pos)

def _parse_function_756(_ctx, _text, _pos):
    # Begin Str
    value92 = ']'
    end92 = (_pos + 1)
    if (_text[slice(_pos, end92, None)] == value92):
        _result = value92
        _pos = (yield (3, _ctx._try__ignored, end92))[2]
        _status = True
    else:
...
def _try_SquareList(_ctx, _text, _pos, T):
    ...
    # Begin Call
    # SurroundedList('[', T, ']')
    arg56 = _wrap_string_literal('[', _parse_function_754)
    arg57 = _wrap_string_literal(']', _parse_function_756)
    func74 = _ParseFunction(_ctx._try_SurroundedList, (arg56, T, arg57), ())
    (_status, _result, _pos) = (yield (3, func74, _pos))
    # End Call
    yield (_status, _result, _pos)
...
SquareList = ParsingRule('SquareList', _parse_SquareList, """
    SquareList(T) = SurroundedList('[', T, ']')
""")
def _raise_error754(_text, _pos):
    if (len(_text) <= _pos):
        title = 'Unexpected end of input.'
        line = None
        col = None
...
_ctx._try_Globals = _try_Globals
_ctx._try_Template = _try_Template
_ctx._try_Variable = _try_Variable
_ctx._try_AnnotatedName = _try_AnnotatedName
...
_ctx._try_Storage = _try_Storage
...
_ctx._try_Reference = _try_Reference
...
_ctx._try_FallbackCase = _try_FallbackCase
...
_ctx._try_OptParenthesesList = _try_OptParenthesesList
